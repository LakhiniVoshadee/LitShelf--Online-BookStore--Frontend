...
export function Auth() {
    ...
    const { register: registerSignUp, handleSubmit: handleSubmitSignUp, watch, formState: { errors } } = useForm<SignUpFormData>();
    ...
    const registerUser = async (data: SignUpFormData) => {
        try {
            ...
            const userData = {
                id: Date.now(), // Temporary ID, backend will assign proper ID
                username: data.username,
                password: data.password,
                role: "customer" // Default role, can be adjusted based on requirements
            };
                ...
                <div className="bg-white rounded-3xl shadow-2xl overflow-hidden backdrop-blur-sm bg-opacity-95">
                    <div className="flex bg-gray-50">
                        <button
                            ...
                            className={`flex-1 py-4 px-6 font-semibold transition-all duration-300 ${isLogin ? 'bg-orange-500 text-white shadow-lg' : 'text-gray-600 hover:text-orange-500'}`}
                        >
                            Login
                        </button>
                        <button
                    ...
                    <div className="p-8">
                        {/* Login Form */}
                        <form className={`space-y-6 ${isLogin ? '' : 'hidden'}`} onSubmit={handleSubmitLogin(authenticateUser)}>
                        ...
                        {/* SignUp Form */}
                        <form className={`space-y-6 ${!isLogin ? '' : 'hidden'}`} onSubmit={handleSubmitSignUp(registerUser)}>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type="email"
                                        id="username"
                                        {...registerSignUp("username", { required: "Email is required" })}
                                        className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
                                        placeholder="Enter your email"
                                    />
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        type="password"
                                        id="confirmPassword"
                                        {...registerSignUp("confirmPassword", { required: "Confirm Password is required", validate: value => value === watch("password") || "Passwords do not match" })}
                                        className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white"
